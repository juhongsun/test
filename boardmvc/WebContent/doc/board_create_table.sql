...
VALUES(CATEGORY_CSEQ.NEXTVAL, '갤럭시S8');

INSERT INTO CATEGORY (CCODE, CNAME)
VALUES(CATEGORY_CSEQ.NEXTVAL, '갤럭시NOTE7');

INSERT INTO CATEGORY (CCODE, CNAME)
VALUES(CATEGORY_CSEQ.NEXTVAL, '아이폰7'); 
...
VALUES (BOARD_LIST_SEQ.NEXTVAL, '갤럭시S8 공지사항', 1, 1);

INSERT INTO BOARD_LIST (BCODE, BNAME, BTYPE, CCODE)
VALUES (BOARD_LIST_SEQ.NEXTVAL, '갤럭시S8 일반게시판', 4, 1);

INSERT INTO BOARD_LIST (BCODE, BNAME, BTYPE, CCODE)
VALUES (BOARD_LIST_SEQ.NEXTVAL, '갤럭시S8 묻고답하기', 5, 1);

INSERT INTO BOARD_LIST (BCODE, BNAME, BTYPE, CCODE)
VALUES (BOARD_LIST_SEQ.NEXTVAL, '갤럭시S8 자랑하기', 6, 1);

INSERT INTO BOARD_LIST (BCODE, BNAME, BTYPE, CCODE)
VALUES (BOARD_LIST_SEQ.NEXTVAL, '갤럭시S8 자료실', 7, 1);

INSERT INTO BOARD_LIST (BCODE, BNAME, BTYPE, CCODE)
VALUES (BOARD_LIST_SEQ.NEXTVAL, '갤럭시NOTE7 공지사항', 1, 2);

INSERT INTO BOARD_LIST (BCODE, BNAME, BTYPE, CCODE)
VALUES (BOARD_LIST_SEQ.NEXTVAL, '갤럭시NOTE7 한줄메모', 3, 2);

INSERT INTO BOARD_LIST (BCODE, BNAME, BTYPE, CCODE)
VALUES (BOARD_LIST_SEQ.NEXTVAL, '갤럭시NOTE7 일반게시판', 4, 2);

INSERT INTO BOARD_LIST (BCODE, BNAME, BTYPE, CCODE)
VALUES (BOARD_LIST_SEQ.NEXTVAL, '갤럭시NOTE7 답변게시판', 5, 2);

INSERT INTO BOARD_LIST (BCODE, BNAME, BTYPE, CCODE)
VALUES (BOARD_LIST_SEQ.NEXTVAL, '갤럭시NOTE7 사진자랑', 6, 2);

INSERT INTO BOARD_LIST (BCODE, BNAME, BTYPE, CCODE)
VALUES (BOARD_LIST_SEQ.NEXTVAL, '갤럭시NOTE7 자료공유', 7, 2);

INSERT INTO BOARD_LIST (BCODE, BNAME, BTYPE, CCODE)
VALUES (BOARD_LIST_SEQ.NEXTVAL, '아이폰7 한줄메모', 3, 3);

INSERT INTO BOARD_LIST (BCODE, BNAME, BTYPE, CCODE)
VALUES (BOARD_LIST_SEQ.NEXTVAL, '아이폰7 QNA', 5, 3);

INSERT INTO BOARD_LIST (BCODE, BNAME, BTYPE, CCODE)
VALUES (BOARD_LIST_SEQ.NEXTVAL, '아이폰7 폰인증', 6, 3);

INSERT INTO BOARD_LIST (BCODE, BNAME, BTYPE, CCODE)
VALUES (BOARD_LIST_SEQ.NEXTVAL, '아이폰7 앱공유', 7, 3);
